...
const genreInfo = [
  {
    ...
    path: "/rock/*",
    image: "src/assets/genres-imgs/electricGuitar.png",
  ...
  },
  {
    ...
    path: "/jazz/*",
    image: "src/assets/genres-imgs/3.jpg",
  ...
  },
  {
    ...
    path: "/reggae/*",
    image: "src/assets/genres-imgs/2.jpg",
  ...
  },
  {
    ...
    path: "/metal/*",
    image: "src/assets/genres-imgs/metal.jpg",
  ...
  },
  {
    ...
    path: "/punk/*",
    image: "src/assets/genres-imgs/punk.jpg",
  ...
  },
  {
    ...
    path: "/country/*",
    image: "src/assets/genres-imgs/5.jpg",
  ...
  },
  {
    ...
    path: "/classic/*",
    image: "src/assets/genres-imgs/classic1.jpg",
    link: "https://api.spotify.com/v1/playlists/37i9dQZF1DWV0gynK7G6pD",
    Tlink:
      "https://api.spotify.com/v1/search?type=artist&q=year:2022%20genre:classic",
  },
  {
    title: "INDIE",
    mainText:
    ...
    path: "/indie/*",
    image: "src/assets/genres-imgs/indie.jpg",
  ...
  },
  {
    ...
    path: "/hiphop/*",
    image: "src/assets/genres-imgs/1.jpg",
    link: "https://api.spotify.com/v1/playlists/37i9dQZF1DXcBWIGoYBM5M",
    Tlink:
      "https://api.spotify.com/v1/search?type=artist&q=year:2022%20genre:pop",
  },
  {
    title: "R&B",
    mainText:
    ...
    path: "/r&b/*",
    image: "src/assets/genres-imgs/rb.jpg",
  ...
  },
  {
    ...
    path: "/electro/*",
    image: "src/assets/genres-imgs/4.jpg",
  ...
  },
  {
    ...
    path: "/blues/*",
    image: "src/assets/genres-imgs/blues.jpg",
